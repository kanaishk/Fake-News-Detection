...
estimator.append(('RFC',RandomForestClassifier(n_estimators=350, min_samples_split=29, min_samples_leaf=8, max_features='sqrt', max_depth=55, criterion='gini', random_state=RANDOM_STATE)))
estimator.append(('GBC',GradientBoostingClassifier(n_estimators=300, min_samples_split=62, min_samples_leaf=22, max_features='sqrt', max_depth=6, learning_rate=0.08, criterion='friedman_mse',  random_state=RANDOM_STATE)))
...
with open(os.path.join(model_dir,'trained_tuned_model_bf.pkl'), 'wb') as f:
