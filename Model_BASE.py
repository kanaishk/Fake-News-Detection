...
# ,'clean_headline_tokens','headline','news','headline_len','news_len','caps_in_headline','caps_in_news'
...
X_train_tfidf, y_train = undersampler.fit_resample(X_train_tfidf, y_train)
